...
function getValuesCurrentTestCases(currentTestCases: Array<{ test: Test; testCaseResult: TestCaseResult }> = []) {
...
export default function getSummary(aggregatedResults: AggregatedResult, options?: SummaryOptions): string {
    ...
    const suites = `${
        ...
        (suitesPending ? `${chalk.bold.yellow(`${suitesPending} skipped`)}, ` : '') +
    ...
    const tests = `${
        chalk.bold('Tests:       ') +
        (updatedTestsFailed > 0 ? `${chalk.bold.red(`${updatedTestsFailed} failed`)}, ` : '') +
        (updatedTestsPending > 0 ? `${chalk.bold.yellow(`${updatedTestsPending} skipped`)}, ` : '') +
        (updatedTestsTodo > 0 ? `${chalk.bold.magenta(`${updatedTestsTodo} todo`)}, ` : '') +
        (updatedTestsPassed > 0 ? `${chalk.bold.green(`${updatedTestsPassed} passed`)}, ` : '')
    }${updatedTestsTotal} total`;

    const snapshots = `${
        chalk.bold('Snapshots:   ') +
        (snapshotsFailed ? `${chalk.bold.red(`${snapshotsFailed} failed`)}, ` : '') +
        (snapshotsOutdated && !snapshotsDidUpdate ? `${chalk.bold.yellow(`${snapshotsOutdated} obsolete`)}, ` : '') +
        (snapshotsOutdated && snapshotsDidUpdate ? `${chalk.bold.green(`${snapshotsOutdated} removed`)}, ` : '') +
        (snapshotsFilesRemoved && !snapshotsDidUpdate
            ? `${chalk.bold.yellow(`${pluralize('file', snapshotsFilesRemoved)} obsolete`)}, `
            : '') +
        (snapshotsFilesRemoved && snapshotsDidUpdate
            ? `${chalk.bold.green(`${pluralize('file', snapshotsFilesRemoved)} removed`)}, `
            : '') +
        (snapshotsUpdated ? `${chalk.bold.green(`${snapshotsUpdated} updated`)}, ` : '') +
        (snapshotsAdded ? `${chalk.bold.green(`${snapshotsAdded} written`)}, ` : '') +
        (snapshotsPassed ? `${chalk.bold.green(`${snapshotsPassed} passed`)}, ` : '')
